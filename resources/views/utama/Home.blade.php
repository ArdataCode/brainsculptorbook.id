...
<head>
  ...
  @font-face {
      ...
      src: url('{{ asset("font/Gotham-Book.otf") }}');
  }
   @font-face {
      font-family: Gotham-Bold;
      src: url('{{ asset("font/Gotham-Bold.otf") }}');
  }
  @font-face {
      font-family: Gotham-Medium;
      src: url('{{ asset("font/Gotham-Medium.otf") }}');
  }
  </style>
</head>
<body>
<section id="sec1">
  <div class="float">
    <a href="#sec4"><img src="{{asset('image/global/section1/float.png')}}" alt=""></a>
  </div>
  <div>
    <img src="{{asset('image/global/section1/bg.jpg')}}" alt="" width="100%">
  </div>
</section>
<section id="sec2">
...
<div class="modal" id="modalSinopsis">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <img src="{{asset('image/global/section2/sinopsis.jpg')}}" alt="" style="margin-top: -70px;width:100%">
      <!-- Modal body -->
    </div>
  </div>
</div>
...
<div class="modal" id="modalDaftar">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <img src="{{asset('image/global/section2/daftar_isi.jpg')}}" alt="" style="margin-top: -70px;width:100%">
      <!-- Modal body -->
    </div>
  </div>
</div>
...
<section id="sec3">
  <div class="sec3-1">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <img src="{{asset('image/global/section3/3-1.png')}}" alt="" width="100%">
        </div>
    ...
    <div class="container">
      <div class="d-none d-md-block d-lg-block">
        <div class="row">
          ...
          <div class="col-sm-6">
            <img src="{{asset('image/global/section3/3-2.png')}}" alt="" width="100%">
          </div>
        </div>
      </div>
  ...
  <div class="sec3-3">
    <div class="container">
      <div class="row">
        <div class="col-sm-4">
          <img src="{{asset('image/global/section3/3-3.png')}}" alt="" width="100%">
        </div>
        <div class="col-sm-1">
        </div>
...
<section id="sec5">
  <img src="{{asset('image/global/section5/klik.png')}}" alt="" class="img-klik d-none d-md-block d-lg-block">
  <div class="container">
    <div class="header">
    ...
    <ul class="nav nav-pills" role="tablist">
      <li class="nav-item" style="z-index:1">
        <a class="x nav-link active" data-bs-toggle="pill" href="#tab1" id="btn-tab1">
          <div class="div-btn">
            <img class="img-btn img1" src="{{asset('image/global/section5/tab1-on.png')}}" alt="">
            <div class="ket-btn">
              <span>KOMIK</span>
            </div>
          </div>
      ...
      <li class="nav-item">
        <a class="x nav-link" data-bs-toggle="pill" href="#tab2" id="btn-tab2">
          <div class="div-btn">
            <img class="img-btn" src="{{asset('image/global/section5/tab2-on.png')}}" alt="">
            <div class="ket-btn">
            <span>ULASAN</span>
            </div>
          </div>
    ...
    <div class="tab-content">
      <div id="tab1" class="container tab-pane active">
        <img src="{{asset($template[0]->foto)}}" width="100%" alt="" class="d-none d-md-block d-lg-block">
        <img src="{{asset($template[0]->foto_m)}}" width="100%" alt="" class="d-block d-md-none d-lg-none">
      </div>
      <div id="tab2" class="container tab-pane">
        <img src="{{asset($template[1]->foto)}}" width="100%" alt="" class="d-none d-md-block d-lg-block">
        <img src="{{asset($template[1]->foto_m)}}" width="100%" alt="" class="d-block d-md-none d-lg-none">
      </div>
      <div id="tab3" class="container tab-pane">
        <img src="{{asset($template[2]->foto)}}" width="100%" alt="" class="d-none d-md-block d-lg-block">
        <img src="{{asset($template[2]->foto_m)}}" width="100%" alt="" class="d-block d-md-none d-lg-none">
      </div>
      <div id="tab4" class="container tab-pane">
        <img src="{{asset($template[3]->foto)}}" width="100%" alt="" class="d-none d-md-block d-lg-block">
        <img src="{{asset($template[3]->foto_m)}}" width="100%" alt="" class="d-block d-md-none d-lg-none">
      </div>
      <div id="tab5" class="container tab-pane">
        <img src="{{asset($template[4]->foto)}}" width="100%" alt="" class="d-none d-md-block d-lg-block">
        <img src="{{asset($template[4]->foto_m)}}" width="100%" alt="" class="d-block d-md-none d-lg-none">
      </div>
    </div>
    <br>
    <br>
...
<section id="sec6">
  <div class="d-none d-md-block d-lg-block">
  <div class="sec6-bg">
    <img src="{{asset('image/global/section6/bg.jpg')}}" alt="" width="100%">
  </div>
  <div class="sec6-isi">
    <div class="row">
      <div class="col-lg-6 col-md-6">
      ...
      <div class="col-lg-5 col-md-5">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 bg-blue">
            ...
            <div class="row bg-blue-x">
              <div class="col-lg-3 col-md-3">
                <img src="{{asset('image/global/section6/btn-fb.png')}}" width="100%" alt="">
              </div>
          ...
          <div class="col-lg-6 col-md-6 bg-blue">
            ...
            <div class="row bg-blue-x">
              <div class="col-lg-3 col-md-3">
                <img src="{{asset('image/global/section6/btn-ig.png')}}" width="100%" alt="">
              </div>
              <div class="col-lg-9 col-md-9">
                <span class="bg-blue-text">Irene Phiter</span>
              </div>
        ...
        <div class="row" style="margin-top:1vw">
          <div class="col-lg-6 col-md-6 bg-blue">
            ...
            <div class="row bg-blue-x">
              <div class="col-lg-3 col-md-3">
                <img src="{{asset('image/global/section6/btn-yt.png')}}" width="100%" alt="">
              </div>
              <div class="col-lg-9 col-md-9">
          ...
          <div class="col-lg-8 col-md-8 bg-blue">
            ...
            <div class="row bg-blue-x">
              <div class="col-lg-2 col-md-2">
                <img src="{{asset('image/global/section6/btn-wa.png')}}" width="100%" alt="">
              </div>
              <div class="col-lg-9 col-md-9">
  ...
  <div class="d-block d-md-none d-lg-none">
     <div>
        <img src="{{asset('image/global/section6/mobile/bg.jpg')}}" alt="" width="100%">
     </div>
     <div style="position:absolute">
        <img src="{{asset('image/global/section6/mobile/bg2.jpg')}}" alt="" width="100%">
     </div>
     <div class="sec6-m">
        <h4 class="header">CONNECT WITH ME</h4>
        <div class="row">
