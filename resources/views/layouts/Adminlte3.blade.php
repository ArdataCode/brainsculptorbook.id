      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{$menu=='master' ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/template')}}" class="nav-link {{$submenu=='template' ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/slider')}}" class="nav-link {{$submenu=='slider' ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/video')}}" class="nav-link {{$submenu=='video' ? 'active' : '' }}">
                  <i class="far fa-images"></i>
                  <p>
                    Video
                  </p>
            ...
            <!-- <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('kategoripelatihan')}}" class="nav-link {{$submenu=='kategoripelatihan' ? 'active' : '' }}">
            ...
            <!-- <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('instrukturmst')}}" class="nav-link {{$submenu=='instrukturmst' ? 'active' : '' }}">
            ...
            <!-- <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('pelatihanmst')}}" class="nav-link {{$submenu=='pelatihanmst' ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{url('admin/user')}}" class="nav-link {{$menu=='user' ? 'active' : '' }}">
