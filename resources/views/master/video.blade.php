            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                    ...
                    <textarea name="link[]" id="link_{{$key->id}}" rows="5" class="form-control" placeholder="Link">{{$key->link}}</textarea>  
                </div>
                <!-- <div class="form-group">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_{{$key->id}}" class="form-horizontal">
            @csrf
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus data video {{$key->judul}}?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <textarea name="link_add" id="link_add" rows="5" class="form-control" placeholder="Link"></textarea>  
              </div>
              <!-- <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "{{ url('admin/hapusvideo') }}/"+idform;
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "{{ url('admin/updatevideo') }}/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
